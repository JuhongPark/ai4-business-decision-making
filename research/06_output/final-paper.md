...
The main research question of this study is: What factors determine whether AI-supported business decisions lead to better organizational performance? To answer this question, the study combines a structured literature review, cross-functional application mapping, comparative case analysis, and synthesis of an analytical framework for responsible AI adoption in business.
...
AI is applied across multiple business functions, but not all decision environments are equally suitable for AI support. In marketing, AI is commonly used for customer segmentation, recommendation, churn prediction, and pricing. In finance, it supports fraud detection, underwriting, and risk assessment. In operations, it is used for demand forecasting, routing, scheduling, and inventory planning. In human resources, it appears in screening, attrition prediction, and workforce planning. In strategy, AI is used more cautiously for market sensing, scenario analysis, and decision support.

The strongest use cases tend to occur where decisions are repeated, measurable, and supported by large amounts of relevant data. This helps explain why marketing, finance, and operations show stronger maturity than strategy or human resources in many contexts.
...
Additional risks include weak explainability, algorithm aversion, overreliance on model outputs, and unclear accountability when errors occur. These risks are particularly serious in finance and human resources, where AI can affect fairness, access, and organizational legitimacy.
