# Case Note: Amazon experimental AI recruiting tool

case_name: Amazon experimental AI recruiting tool
...
Amazon sought to automate parts of candidate screening in order to process large volumes of applications more efficiently.

## AI Application

The experimental system learned from historical resumes and produced candidate rankings for technical roles.

## Decision Supported

The tool was intended to support resume screening and candidate ranking decisions.
...
This is the clearest negative case in the set. It shows why HR is a high-oversight domain and why performance alone cannot justify AI use in sensitive people decisions.
