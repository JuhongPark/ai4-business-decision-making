# Business-Context AI Alignment Research Focus
...
- `research/core/framework/framework-summary.md`
- `research/core/framework/evaluation-framework.md`
- `research/core/taxonomy/taxonomy-summary.md`
- `research/core/taxonomy/decision-tree.md`
...
- `research/delivery/output/executive-summary.md`
...
- `research/extensions/three-part-study/three-part-study-plan.md`
- `research/extensions/three-part-study/part2-infrastructure.md`
- `research/extensions/three-part-study/part3-organization.md`
- `research/extensions/adaptive-governance/adaptive-governance-summary.md`
...
- `research/core/drafting/introduction.md`
- `research/extensions/three-part-study/three-part-study-plan.md`
- `research/extensions/three-part-study/part3-organization.md`
...
- `research/core/framework/evaluation-framework.md`
- `research/core/taxonomy/decision-tree.md`
- `research/delivery/publication-prep/domain-recommendation-table.md`
