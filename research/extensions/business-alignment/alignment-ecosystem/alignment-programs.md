...
summary: Reference scan of programs, bootcamps, fellowships, and governance organizations in the AI alignment ecosystem.
...
This document maps where research experience is built in the AI alignment and governance ecosystem and which organizations appear to shape the field most strongly.

Related references: [alignment-codebases.md](alignment-codebases.md) and [ai-safety-fellowships-directory.md](ai-safety-fellowships-directory.md).

> **Sourcing:** Program statistics such as publications, alumni destinations, and cohort sizes are taken from program websites. These are self-reported figures and are not independently verified. Snapshot date: 2026-03-26.
...
Real career paths are non-linear; the map below simplifies the relationships between common entry programs.
...
## Why This Matters for the Business-Alignment Track
