...
| --- | --- |
| `taxonomy/decision-tree.md` | workflow branching logic |
| `taxonomy/decision-rules.md` | authority assignment rules |
| `scenario-packs/*` | scenario transitions and examples |
| `framework/evaluation-framework.md` | stage-level evaluation criteria |
| `revision/governance-memo.md` | escalation and fallback principles |
...
| --- | --- |
| `expansion/evidence-tier-method.md` | evidence system design |
| `publication-prep/evidence-register.md` | evidence management reference |
| `framework/evaluation-framework.md` | translate evaluation dimensions into infrastructure requirements |
| `literature/reading-notes/nist2023.md` | governance reference standard |
| `literature/reading-notes/eeoc2023.md` | fairness monitoring requirements |
| `literature/reading-notes/fda2025aimd.md` | healthcare infrastructure requirements |
| `literature/reading-notes/sec2017robo.md` | investment-domain infrastructure requirements |
...
| --- | --- |
| `revision/governance-memo.md` | translate governance principles into roles and responsibilities |
| `taxonomy/decision-tree.md` | authority assignment sequence |
| `literature/reading-notes/jarrahi2018.md` | human-AI complementarity implications |
| `literature/reading-notes/dietvorst2015.md` | algorithm aversion and trust calibration |
| `literature/reading-notes/brynjolfsson2011.md` | organizational complements for decision performance |
| `domain-analysis/analysis.md` | domain-specific operating differences |
