...
- `research/framework/framework-summary.md`
- `research/framework/evaluation-framework.md`
- `research/taxonomy/summary.md`
- `research/taxonomy/decision-tree.md`
...
- `research/output/executive-summary.md`
- `research/output/thinktank-report.md`
...
- `research/three-part-study/research-plan.md`
- `research/three-part-study/part2-infrastructure.md`
- `research/three-part-study/part3-organization.md`
- `research/adaptive-governance/summary.md`
...
- `research/drafting/introduction.md`
- `research/three-part-study/research-plan.md`
- `research/three-part-study/part3-organization.md`
...
- `research/framework/evaluation-framework.md`
- `research/taxonomy/decision-tree.md`
- `research/publication-prep/domain-recommendation-table.md`
